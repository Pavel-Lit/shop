...
public class ProductController {
    ...
    @GetMapping("")
    public PageDto getAllProducts(@RequestParam(name = "page", defaultValue = "1") @Parameter(description = "Номер страницы", required = true) Integer page,
                                  @RequestParam(name = "page_size", defaultValue = "10") @Parameter(description = "Колличество продуктов на странице", required = false) Integer pageSize,
                                  ...
                                  @RequestParam(name = "min_price", required = false) @Parameter(description = "Фильтр по минимальной цене продукта", required = false)Integer minPrice,
                                  @RequestParam(name = "max_price", required = false) @Parameter(description = "Фильтр максимальной цене продукта", required = false) Integer maxPrice){
